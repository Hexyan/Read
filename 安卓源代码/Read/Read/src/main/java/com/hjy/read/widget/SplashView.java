...
public class SplashView extends View {
  ...
  private boolean mRemoveFromParentOnEnd = true; // a usercheck for removing the view from its parent once the animation is over
  ...
  /**
   * Set the usercheck to remove or keep the view after the animation is over. This is set to true by default. The view must be inside a ViewManager
